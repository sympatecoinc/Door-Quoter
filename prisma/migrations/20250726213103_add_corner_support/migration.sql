...
INSERT INTO "new_Panels" ("createdAt", "glassType", "height", "id", "locking", "openingId", "slidingDirection", "swingDirection", "type", "updatedAt", "width") SELECT "createdAt", "glassType", "height", "id", "locking", "openingId", "slidingDirection", "swingDirection", "type", "updatedAt", "width" FROM "Panels";
DROP TABLE "Panels";
